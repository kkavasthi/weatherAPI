...
public class Constants {
    ...
    public static final String BASE_CONTROLLER_PACKAGE = "com.sapient.backend.controller";
    public static final String SWAGGER_SERVICE_API = "Weather Application API";
    public static final String SWAGGER_SERVICE_OPERATION = "This API will perform weather prediction operations";
